...
public interface MappingCandidates<@NotNull I, @NotNull P>
    extends Iterable<@NotNull MappingCandidate<I, P>> {
  ...
  @NotNull
  @TestOnly
  static <@NotNull I, @NotNull P> MappingCandidates<I, P> forTest(
      @NotNull MappingCandidate<I, P>... mappingCandidates) {
