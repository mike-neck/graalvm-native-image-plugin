...
class ProxyUsageTest {
  ...
  void unmarshalNonEmpty() throws IOException {
    Object proxyUsage =
        objectMapper.readValue("[\"com.example.Foo\",\"com.example.Bar\"]", ProxyUsage.class);

    assertThat(proxyUsage).isEqualTo(new ProxyUsage("com.example.Bar", "com.example.Foo"));
  }
  ...
  void marshalNonEmpty() throws IOException {
    ...
    assertThat(json)
        .isEqualTo("[" + "\"java.lang.AutoCloseable\"" + "," + "\"java.util.List\"" + "]");
  }
}
