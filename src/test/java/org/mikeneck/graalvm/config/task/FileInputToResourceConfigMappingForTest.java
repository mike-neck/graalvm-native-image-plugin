...
@TestOnly
public class FileInputToResourceConfigMappingForTest
  ...
  private static Optional<ResourceConfig> makeResourceConfig(@NotNull String string) {
    ...
    return Optional.of(resourceConfigBuilder.resources(resources).bundles(bundles));
  }
  ...
  private static List<@NotNull ResourceUsage> resourceUsages(@NotNull String... patterns) {
    Transformer<String, ResourceUsage> transformer =
        pattern -> {
  ...
  private static List<@NotNull BundleUsage> bundleUsages(@NotNull String... names) {
    Transformer<String, BundleUsage> transformer =
        name -> {
