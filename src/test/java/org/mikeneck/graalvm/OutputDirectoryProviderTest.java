...
class OutputDirectoryProviderTest {
  ...
  private static void assertThrowsInvalidUserDataException(
      String description, Callable<Object> operation) {
    try {
      operation.call();
      fail(description);
    } catch (Exception e) {
